    ...
    return (
        ...
        >
          <Popup>
            ...
            <b></b>
            <br />
            <button style={{ backgroundColor: "#008cba", cursor: 'pointer', display: 'inline-block', padding: '5px 8px', border: 'none', color: 'white', borderRadius:'5px' }} onClick={() => { window.location.href = `/viewSoil3/${s_id}` }}>View details</button>
          </Popup>
        </Marker>
      );
    };
